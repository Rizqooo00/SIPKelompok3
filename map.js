...
//overlays.addLayer(Persil_Tanah_WP_Kecamatan_Mojotengah,'Persil_Tanah_WP_Kecamatan_Mojotengah');
//overlays.addLayer(Persil_Tanah_WP_Kecamatan_Mojotengah,'Persil_Tanah_WP_Kecamatan_Mojotengah');
...
//layerControl.addOverlay(Persil_Tanah_WP_Kecamatan_Mojotengah,"Persil_Tanah_WP_Kecamatan_Mojotengah");
//layerControl.addOverlay(Persil_Tanah_WP_Kecamatan_Mojotengah,"Persil_Tanah_WP_Kecamatan_Mojotengah");
...
//L.control.layers.addOverlay(Persil_Tanah_WP_Kecamatan_Mojotengah,"test").addTo(map);
layerControl.addBaseLayer(satellite,"satellite");
...
$(function() {
    $("#layer").change(function() {
        ...
        attributes.options[0] = new Option('Pilih Attribute', "Pilih Attribute");
        //  alert(url);
...
$(function() {
    $("#attributes").change(function() {
        ...
        if (value_type == 'xsd:short' || value_type == 'xsd:int' || value_type == 'xsd:double' || value_type == 'xsd:long') {
            ...
            var operator1 = document.getElementById("operator");
            operator1.options[1] = new Option('Admin', 'Admin');
...
function clear_all() {
    ...
    map.flyTo([-7.4051227953286345, 109.90834037352882], 8);

    document.getElementById("query_panel_btn").innerHTML = "☰ Project";
